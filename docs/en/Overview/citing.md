...
Free to use and modify for research and educational purposes
...
We thank all contributors and the open-source projects that make RoboGenesis possible:

NVIDIA Isaac Sim and RMPFlow
