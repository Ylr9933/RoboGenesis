...
- [安装指南](Getting-Started/installation.md) — 系统要求与环境配置
- [快速开始](Getting-Started/first-episode.md) — 运行您的第一个 episode
- [原子技能](Skills/atomic-skills.md) — 9 种原子技能参考
- [教程](Tutorials/data-collection.md) — 数据采集、训练与推理教程
